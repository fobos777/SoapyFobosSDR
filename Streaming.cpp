...
SoapySDR::Stream *SoapyFobosSDR::setupStream(const int direction, const std::string &format,
...
int SoapyFobosSDR::activateStream(SoapySDR::Stream *stream, const int flags, const long long timeNs,
...
int SoapyFobosSDR::readStream(SoapySDR::Stream *stream, void *const *buffs, const size_t numElems, int &flags,
